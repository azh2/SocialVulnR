...
>R Packages (CRAN): 'knitr','sp','sf','spdep','tidycensus','dplyr','tidyr','RColorBrewer','leaflet','ggplot2'
>Census API Key: Get a Free Census API Key Here - https://api.census.gov/data/key_signup.html
